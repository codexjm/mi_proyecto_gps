...
public class DataManager {
    ...
    public String deletePositions(long deviceId) throws SQLException {
        QueryBuilder.create(dataSource,"DELETE FROM tc_positions WHERE deviceid = "+Long.toString(deviceId)).executeUpdate();
        return "ok";
    }
}
